...
export class SortTable extends Component {
  ...
  goods = [
    { id: "Milk", name: "Milk", price: 0.8, inStock: 4, img: "/imgs/milk.jpg", desc: "", new: true, discount: 20 },
    { id: "Butter", name: "Butter", price: 1.3, inStock: 13, img: "/imgs/butter.jpg", desc: "", new: true, discount: 10 },
    { id: "Coffee", name: "Coffee", price: 12, inStock: 23, img: "/imgs/coffee.jpg", desc: "", new: false, discount: 40 },
    { id: "Tea", name: "Tea", price: 13, inStock: 2, img: "/imgs/tea.jpg", desc: "", new: false, discount: 15 },
    { id: "Sugar", name: "Sugar", price: 1.2, inStock: 0, img: "/imgs/sugar.jpg", desc: "", new: false, discount: 30 },
    { id: "Apples", name: "Apples", price: 1, inStock: 16, img: "/imgs/apples.jpg", desc: "", new: false, discount: 25 },
    { id: "Cheese", name: "Cheese", price: 10, inStock: 9, img: "/imgs/cheese.jpg", desc: "", new: true, discount: 5 },
  ];
  styles = {
    td: {
      padding: "10px 20px",
