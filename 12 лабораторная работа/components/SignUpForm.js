...
export class SignUpForm extends React.Component {
  state = {
    disableBtn: true, password: null, login: null, showSignUp: true, showIn: false,disableEmail:true
  };
  disableBtn = (value) => {
  ...
  render() {
    return (
      ...
      <form>
        ...
        <PhoneInput />
        <br />
        <button disabled={(this.state.disableBtn+this.state.disableEmail)} onClick={this.handleBtnClick}>
          send
        </button>
